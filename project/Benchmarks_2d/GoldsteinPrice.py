...
class GoldsteinPrice(Benchmark):
    ...
    def _to_latex(self, r=5, line_breaks=True, parameterized=False, double=False):
        ...
        res = f"$[{p[0]}({p[1]} + {p[2]}({p[3]}x_1 + {p[4]}x_2 + {p[5]})^2 ({p[6]} - {p[7]}x_1 - {p[8]}x_2 + {p[9]}(x_1+{p[10]})^2 + {p[11]}(x_2+{p[12]})^2 + {p[13]}x_1x_2)] \\times [{p[14]} + {p[15]}({p[16]}x_1 - {p[17]}x_2 + {p[18]})^2 ({p[19]} - {p[20]}x_1 + {p[21]}x_2 + {p[22]}(x_2+{p[23]})^2 + {p[24]}(x_1+{p[25]})^2  - {p[26]}x_1x_2)] + {p[27]}$"
